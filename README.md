...
تمام داده‌های پنهان بازی فقط از Vercel Functions خوانده می‌شوند. تغییرات فعال بازی با شمارهٔ بازبینی محافظت شده‌اند و نوشتن قدیمی با پاسخ 409 رد می‌شود. ویرایش چیدمان، متناسب با مدل تک‌بازی‌گردان، آخرین نسخه را ذخیره می‌کند.
